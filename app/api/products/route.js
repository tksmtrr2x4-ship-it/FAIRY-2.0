...
// REINER LESEZUGRIFF: Keine automatische Befüllung oder Veränderung von Serverdaten!
export async function GET() {
  try {
    await dbConnect();
    const Product = mongoose.models.Product;
    
    // Holt alle aktiven Produkte aus der Live-Datenbank
...
// Manuelles Hinzufügen über das Dashboard (Bestehende Daten werden nicht überschrieben)
