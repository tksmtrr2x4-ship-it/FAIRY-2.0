    ...
    <div className={isDarkMode ? 'dark' : ''}>
      <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-[#1D1D1F] dark:text-zinc-100 font-sans antialiased flex flex-col selection:bg-[#D31329] selection:text-white transition-colors duration-500">
        ...
        <div className="flex-1 grid grid-cols-12 gap-6 p-8">
          <main className="col-span-8 flex flex-col gap-6">
            <div className="relative shadow-sm rounded-2xl">
              <input 
                ...
                className="w-full px-6 py-4 rounded-2xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-base focus:outline-none focus:ring-4 focus:ring-[#D31329]/10 focus:border-[#D31329] transition-all duration-300 shadow-sm font-medium text-gray-800 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-zinc-500"
              />
            </div>
          ...
          <aside className="col-span-4 bg-white/70 dark:bg-zinc-900/70 border border-gray-200/50 dark:border-zinc-800/50 rounded-3xl p-6 flex flex-col justify-between shadow-xl backdrop-blur-lg">
            <div>
