// lib/dbConnect.js - [Zentrale Mongoose-Modellregistrierung]
...
// Registriert alle Schemata global in Mongoose (Verhindert jegliche Doppel-Registrierungen)
function registerModels() {
  ...
  if (!mongoose.models.Product) {
    const ProductSchema = new mongoose.Schema({
      ...
      // Restbestand wird von Hand gepflegt, die Kasse rechnet nichts ab.
      // null bedeutet "nicht gepflegt" - dann warnt das System auch nicht.
  ...
  if (!mongoose.models.Sale) {
    const SaleSchema = new mongoose.Schema({
      ...
      // Im Browser erzeugte Bon-Kennung. Additiv ergänzt: Altbelege ohne dieses
      // Feld bleiben unverändert gültig. Dient der Doppelbuchungssperre.
  ...
  if (!mongoose.models.Period) {
    ...
    console.log("Global Period model registered.");
  }
}
